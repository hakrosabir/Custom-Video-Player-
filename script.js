...
// Create functions for the updatating the play / pause icons
...
// Create a function to update a progress bar
function updateProgress(){
    ...
    timestamp.innerHTML = `${mins}:${secs}`;        // template laterl upper on tab button
...
//Create a function to update the video progress using the slider
